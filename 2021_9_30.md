...
![image-20210930085135855](C:\Users\WIN10\AppData\Roaming\Typora\typora-user-images\image-20210930085135855.png)

为得到权重，优化真实密度与估计密度的 “**KLIC距离**”，如下：

![930_2](D:\文献1\2021_930_pic\930_2.png)

<img src="D:\文献1\2021_930_pic\930_3.png" alt="930_3" style="zoom:90%;" />

真实分布与待优化参数无关，故可直接优化估计密度的对数似然函数（对数分数）；KLIC距离的性质可保证估计结果在样本内不会更差。

![image-20210930090448213](C:\Users\WIN10\AppData\Roaming\Typora\typora-user-images\image-20210930090448213.png)

- **方法说明**：该方法可以和一种拟合优度检验——Berkowitz (2001)LR test联系起来，其检验统计量与KLIC距离仅差一个常系数；但是该文章未证明其最优性。不过提供了一种检验估计密度的方法。

![image-20210930091517690](C:\Users\WIN10\AppData\Roaming\Typora\typora-user-images\image-20210930091517690.png)
...
- **组合方式**：线性组合，使用最大化**对数分数**优化权重（与上一篇类似）
  ...
  ![image-20210930101059319](C:\Users\WIN10\AppData\Roaming\Typora\typora-user-images\image-20210930101059319.png)



![image-20210930101158904](C:\Users\WIN10\AppData\Roaming\Typora\typora-user-images\image-20210930101158904.png)
...
- **组合方式**：三种方式：**线性组合**（LiOP）、**乘积组合**（LoOP）、Kamstra and Kennedy(1998) 的组合方式（**KK**）
  ...
  ![image-20210930112238585](C:\Users\WIN10\AppData\Roaming\Typora\typora-user-images\image-20210930112238585.png)

  ![930_9](D:\文献1\2021_930_pic\930_9.png)

  ![image-20210930112600251](C:\Users\WIN10\AppData\Roaming\Typora\typora-user-images\image-20210930112600251.png)
...
- ***
  ...
  ***M5 Competition Uncertainty: Overdispersion,distributional forecasting, GAMLSS and beyond*** (Florian Ziel, 2021) (arXiv):
  ...
  ![930_11](D:\文献1\2021_930_pic\930_11.png)
